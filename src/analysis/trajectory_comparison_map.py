"""
Module Name: trajectory_comparison_map.py
Description: Baseline vs shift trajectory comparison map generator for analysis pipeline.
Author: Som
Date: 2025-10-04

Generates interactive HTML maps comparing baseline vs shifted trajectories with
conflict detection and hallucination analysis visualization.
"""
